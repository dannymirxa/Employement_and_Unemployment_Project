...
library(xlsx)
population_df <- read.xlsx("./Data/no19.xlsx", sheetIndex = 1, rowIndex = 6:91, colIndex = 1:7)
lifeexp_df <- read.xlsx("./Data/no19.xlsx", sheetIndex = 3, rowIndex = 12:66, colIndex = 1:11)
birthrate_df <- read.xlsx("./Data/no19.xlsx", sheetIndex = 2, rowIndex = 13:117, colIndex = 1:9)
labour_df <- read.xlsx("./Data/no9.xlsx", sheetIndex = 1, rowIndex = 5:43, colIndex = 2:13)
employ_df <- read.xlsx("./Data/no1.xlsx", sheetIndex = 1, rowIndex = 5:43, colIndex = 2:13)
malewf_df <- read.xlsx("./Data/no18.xlsx", sheetIndex = 1, rowIndex = 8:46, colIndex = 2:9)
femalewf_df <- read.xlsx("./Data/no18.xlsx", sheetIndex = 2, rowIndex = 8:46, colIndex = 2:9)
